//! Instruction timing.
//!
//! This module deals with the amount of physical time an instruction
//! takes.  The operator has some control over the execution speed of
//! the computer.  These figures are taken from section 7-8 of the
//! User Handbook.
